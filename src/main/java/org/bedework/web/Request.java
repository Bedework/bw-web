...
public class Request extends ReqUtil implements Logged {
  ...
  // Identifies us in messages etc.
  private final String id;

  public final static String appvarsAttrName =
          "org.bedework.client.appvars";

  public final static String currentUserAttrName =
          "org.bedework.web.current.user";
  ...
  public MessageEmit getErr() {
    return ErrorEmitWeb.getErrorObj(getRequest(), getId(), false);
  }
  ...
  public MessageEmit getMsg() {
    return MessageEmitWeb.getErrorObj(getRequest(), getId(), false);
  }
  ...
  public String getCurrentUser() {
    return (String)getSessionAttr(currentUserAttrName);
  }
