 ...
 */
public class WebForbidden extends WebException {
  /** Constructor
   */
  public WebForbidden() {
   ...
   * @param msg
   */
  public WebForbidden(final String msg) {
   ...
   * @param errorTag
   */
  public WebForbidden(final QName errorTag) {
   ...
   * @param msg
   */
  public WebForbidden(final QName errorTag, final String msg) {
